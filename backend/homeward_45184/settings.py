"""
Django settings for homeward_45184 project.
...
ROOT_URLCONF = 'homeward_45184.urls'
...
WSGI_APPLICATION = 'homeward_45184.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "homeward_45184 API",
    "DESCRIPTION": "API documentation for homeward_45184 App",
    "VERSION": "v1",
}
